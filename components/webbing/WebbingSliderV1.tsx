...
export default function DesignSliderV1({ label, min, max, step = undefined, start = undefined, init = undefined, marks = undefined, valueDisplay = undefined, onChangeFunc = undefined, tooltip = "" }: Props) {
